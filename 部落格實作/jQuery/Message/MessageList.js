$(function () {
    $(".editMessage").click(function () {
        ...
        //把留言內容改為輸入方塊
        $(this).closest('tr').prev('tr').prev('tr').children('tq:eq(1)').html("<input class='editInput'>");
        ...
        $(".sentMessage").click(function () {
            var $editInput = $(this).closest('tr').prev('tr').prev('tr').children('tq:eq(1)').children('input').val(); console.log($editInput);
            ...
            //因此可將此按鈕路徑轉為指向BlogController中的UpdateMessage Action
